        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVELOP & DEVOPS</h3>
              <h4>Description</h4>
              <p>
                Building robust, scalable full-stack web applications and deploying them to highly available cloud architectures with automated CI/CD pipelines.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing interactive, modern user experiences using wireframes, high-fidelity prototypes, and user-centric UI components.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
